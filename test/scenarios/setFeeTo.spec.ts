...
describe('scenario:setFeeTo', () => {
  ...
  beforeEach('deploy Bangswap v2', async () => {
    factory = await deployContract(wallet, BangswapV2Factory, [timelock.address])
  })
  ...
  it('setFeeTo', async () => {
    ...
    const description = 'Set feeTo on the BangswapV2Factory to the timelock address.'

    // activate balances
    await bang.delegate(wallet.address)
